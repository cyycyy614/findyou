 ...
 * <p>
 * 【Android】解决ViewPager嵌套时Fragment的mUserVisibleHint属性不同步的问题 - 简书 - http://www.jianshu.com/p/e7449278e33d
 * <br>
...
//    private static final boolean DEBUG = true;
    ...
    public void activityCreated() {
        if (DEBUG) {
            Log.d(TAG, "activityCreated()..." + fragmentName + ": activityCreated, userVisibleHint=" + fragment.getUserVisibleHint());
        }
        ...
        if (fragment.getUserVisibleHint()) {
            ...
            if (parentFragment != null && !parentFragment.getUserVisibleHint()) {
                if (DEBUG) {
                    Log.d(TAG, "activityCreated()..." + fragmentName + ": activityCreated, parent " + parentFragment.getClass().getSimpleName() + "is hidden, therefore hidden self");
                }
    ...
    public void resume() {
        if (DEBUG) {
            Log.w(TAG, "resume()..." + fragmentName + ": resume, userVisibleHint=" + fragment.getUserVisibleHint());
        }
        if (fragment.getUserVisibleHint()) {
    ...
    public void pause() {
        if (DEBUG) {
            Log.w(TAG, "pause()..." + fragmentName + ": pause, userVisibleHint=" + fragment.getUserVisibleHint());
        }
        if (fragment.getUserVisibleHint()) {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        if (DEBUG) {
            ...
            Log.w(TAG, "setUserVisibleHint()..." + fragmentName + ": setUserVisibleHint, userVisibleHint=" + isVisibleToUser + ", " + (fragment.isResumed() ? "resume" : "pause") + ", " + parent);
        }
