...
public class MyNotificationManager {
    ...
    @RequiresApi(api = Build.VERSION_CODES.O)
    public static void showChannel1Notification(Context context, String title, String content) {
        int notificationId = 0x1234;
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(app.getContext().getResources(),R.drawable.logo, null);
