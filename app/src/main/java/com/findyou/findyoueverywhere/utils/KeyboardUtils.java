...
public class KeyboardUtils {
     ...
     */
    public static boolean showSoftInput(final Activity activity) {
    ...
    public static void hideSoftInput(final Activity activity) {
        if(!isKeyboardShow(activity)) return;
        View view = activity.getCurrentFocus();
        if (view == null) view = new View(activity);
        InputMethodManager imm = (InputMethodManager) activity.getSystemService(Activity.INPUT_METHOD_SERVICE);
        if (imm == null) return;
    ...
    public static boolean isKeyboardShow(Activity activity) {
        ...
        return screenHeight - rect.bottom - UIUtils.getVirtalBarHeight() != 0;
    }
}
