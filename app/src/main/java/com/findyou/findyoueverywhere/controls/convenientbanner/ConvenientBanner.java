...
import com.findyou.findyoueverywhere.controls.convenientbanner.adapter.CBPageAdapter;
import com.findyou.findyoueverywhere.controls.convenientbanner.holder.CBViewHolderCreator;
import com.findyou.findyoueverywhere.controls.convenientbanner.listener.CBPageChangeListener;
import com.findyou.findyoueverywhere.controls.convenientbanner.listener.OnItemClickListener;
import com.findyou.findyoueverywhere.controls.convenientbanner.view.CBLoopViewPager;
...
//                R.layout.fragment_home_tab_banner, this, true);
        View view = inflate(getContext(), R.layout.fragment_home_tab_banner, this);
    ...
    public ConvenientBanner setPageIndicator(int[] page_indicatorId) {
        ...
        for (int count = 0; count < mDatas.size(); count++) {
            ...
            pointView.getLayoutParams().width = UIUtils.dp2px(getContext(), 12);
            pointView.getLayoutParams().height = UIUtils.dp2px(getContext(), 12);
        }
