...
public class DailyPopWindow  extends BasePopWindow implements OnWheelChangedListener {
    ...
    public int getLayoutId() {
        ...
        return R.layout.daily_pop_window;
    }

    public DailyPopWindow(Activity activity){
        super(activity);
    }
    ...
    public void tv_ok_Click(View view){
        int item = (mIndex + 1) * 60;
        postEvent(new EventMessenger(EventConst.API_DEVICE_SET_DAILY, item));
        close();
    }
}
