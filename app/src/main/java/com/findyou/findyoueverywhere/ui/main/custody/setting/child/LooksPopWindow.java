...
public class LooksPopWindow extends BasePopWindow implements OnWheelChangedListener {
    ...
    public int getLayoutId(){
        return R.layout.looks_pop_window;
    }

    public LooksPopWindow(Activity activity, List<String> items, int index){
        super(activity);
        this.items = items;
        this.mIndex = index;
    }
    ...
    public void tv_ok_Click(View view){
        ...
        postEvent(new EventMessenger(EventConst.API_EDIT_CHILD_LOOKS, mIndex));
        close();
    }
}
