...
public class WheelView extends View {
	...
	// Wheel drawables
	private int wheelBackground = R.drawable.controls_wheel_bg;
	private int wheelForeground = R.drawable.controls_wheel_val;
	...
	int count = 3;
	public void setShadowsCount(int count){
		this.count = count;
	}
	/**
